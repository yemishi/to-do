...
const labelVariants = {
  ...
  down: {
    y: -25,filter: "grayscale(0%) brightness(100%)", opacity: 1,
  }
}
...
export function InputName({ props }) {
  return <span className="flex flex-col mb-10 mt-3 relative items-center duration-500 font-bold">
    ...
    <input id="nameEvent" onChange={(e) => { props.setFormConfig({ ...props.formConfig, name: e.target.value }) }}
      ...
      className="pr-1 hover:cursor-text py-2 hover:scale-x-105 bg-transparent border-b-2 duration-500 cursor-default
