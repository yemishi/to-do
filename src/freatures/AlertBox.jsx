...
export default function Test({ msg, isOpen, toggleOpen }) {
  ...
  return (
    <>
      <motion.div initial={{ y: 100, opacity: 0 }} animate={isOpen == 1 ? 'open' : 'closed'} onClick={() => toggleOpen(0)} variants={divVariant}
        className='absolute left-0 right-0 bottom-0 backdrop-blur-sm rounded-lg items-center flex  
        justify-center bg-teal-300 bg-opacity-50 w-full h-full'>
